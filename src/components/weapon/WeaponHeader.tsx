...
function cardBorderClass(
  ...
  if (isCrafted)                        return 'border-amber-500/70';
          ...
          <div className="flex-1 min-w-0 space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              {activeWeapon.hasCraftedPattern && (
                isCrafted ? (
                  // Active: amber button — click to turn off
                  <button
                    onClick={toggleCrafted}
                    title="Crafted mode active — click to disable"
                    className="text-xs font-semibold px-2 py-1 rounded-md border transition-all flex items-center gap-1.5 bg-amber-500/20 text-amber-400 border-amber-500/50 hover:bg-amber-500/30"
                  >
